...
namespace SalesAdventure3000_UI.Views.DisplayElements
{
    ...
    {
        public static void Draw(ViewEnums.Actions currentAction, List<Item> backpack, int backpackIndex)    //Draws backpack window based on the selected index and whether the window is selected.
        {
            Console.SetCursorPosition(0, 28);
            Console.ForegroundColor = currentAction == ViewEnums.Actions.OpenBackpack ? ConsoleColor.Cyan : ConsoleColor.Gray;  //Checks if the window is active.
